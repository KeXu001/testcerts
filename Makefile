...
SERVER_CHAIN_FILE=$(SERVER_DIR)/Server.pem
...
CLIENT_CHAIN_FILE=$(CLIENT_DIR)/Client.pem
...
server_certs: server_dir $(SERVER_PRIVATE_FILE) $(SERVER_PUBLIC_FILE) $(SERVER_PKCS_FILE) $(SERVER_CHAIN_FILE)

client_certs: client_dir $(CLIENT_PRIVATE_FILE) $(CLIENT_PUBLIC_FILE) $(CLIENT_PKCS_FILE) $(CLIENT_CHAIN_FILE)
...
$(SERVER_CHAIN_FILE): $(SERVER_PUBLIC_FILE) $(INTERMEDIATE_PUBLIC_FILE) $(ROOT_PUBLIC_FILE)
	cat $^ > $@
...
$(CLIENT_CHAIN_FILE): $(CLIENT_PUBLIC_FILE) $(INTERMEDIATE_PUBLIC_FILE) $(ROOT_PUBLIC_FILE)
	cat $^ > $@